...
void loop() {
    ...
    if (runCode) {
        ...
        else if(result.classification[1].value > 0.75){
            myServo.attach(33);
            myServo.write(170);
        ...
        else if(result.classification[2].value > 0.75){
            myServo.attach(33);
            myServo.write(0);
        ...
        else if(result.classification[3].value > 0.75){
            myServo.attach(33);
            myServo.write(170);
        ...
        else if(result.classification[4].value > 0.75){
            myServo.detach();
        }
